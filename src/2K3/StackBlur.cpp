...
void StackBlur::Run(uint8_t* src) noexcept
{
...
void StackBlur::InitPtr(uint8_t* ptr, const StackRGBA& sum) noexcept
{
...
void StackBlur::StackBlurThread(uint32_t step, uint32_t core, uint8_t* src, uint8_t* stack) noexcept
{
